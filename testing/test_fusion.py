# =====================================================
# 🚀 FINAL FUSION TRAINING (FIXED + STABLE)
# =====================================================
...
# =====================================================
# 🔥 BALANCED DATA GENERATION (FIXED)
# =====================================================
def generate_data(n=600):
    ...
    for _ in range(n):
        ...
        # 🔥 BALANCED LABEL (KEY FIX)
        label = 1 if rule_score > 0.5 else 0

        data.append(([ct, clinical, genomic, rule_score, type_conf], label))
